...
struct NrHashMap {
    ...
    // Reference to shared monster hashtable
}
...
impl Dispatch for NrHashMap {
    ...
    fn dispatch(&self, op: Self::ReadOperation) -> Self::Response {
        match op {
            ...
            //
            // If the key is not found in the cache, then
            //      1. Hold the read lock
            //      2. Check if the key is in the monster hashtable
            //      3. If it is a hot object then update the cache
    ...
    fn dispatch_mut(&mut self, op: Self::WriteOperation) -> Self::Response {
        match op {
            ...
            // If the key is found in the cache then update the value
            //
            // If the key is not found in the cache, then
            //     1. Hold the write lock
            //     2. upsert the key-value pair in the monster hashtable
